<div id="contenu" class=" mb-20 pb-10 mr-12 mt-5 w-full  shadow-lg h-auto">
    <div class="pt-2 mr-2 ml-2">
            ...
            <div class="ml-10 mr-10">
                ...
                <div class="w-full mb-6 ">
                    ...
                    <div class=" ml-2 d-flex flex w-full mt-10">
                        ...
                        <div class="ml-24 d-block block">
                            <div class="d-flex flex">
                                <p class=" ml-5 text-xl"><?php echo $infosFiche['dateModif'] ?></p>
                            </div>

                        </div>
                    </div>
                    <table class="w-full bg-blue-table border-solid border-2 border-grey-900 mt-10 ">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($lesinfosForfait as $info) {
                                echo '<tr>
                                        ...
                                        <td class="border-solid border-2 border-black bg-white">' . $info["montant"] . ' EUR</td>
                                        <td class="border-solid border-2 border-black bg-white">' . $info["quantite"] * $info["montant"] . ' EUR</td>
                                    </tr>';
                            }
                            ?>
                    ...
                    <table class="w-full  border-solid border-2 border-grey-900 mt-10 ">
                        <thead class="bg-blue-table">
                            <tr>
                                <th class="w-1/20 d-none deleteAction">Action</th>
                        ...
                        <tbody>
                            <?php foreach ($lesinfosHorsForfait as $infoHF) {
                                echo '<tr>
                        <td class="w-1/20 pb-3 pt-3 text-center d-none deleteAction"><button class="bg-red-700 p-2 w-10 h-10 hover:bg-red-800 rounded-full btn-suppr">
        ...
        <div class="borderButtonValidation d-relative  w-auto mt-5 h-auto pb-5 ml-20 mr-20">
            <p class="w-auto  ">
                <button id="supprimerLigne" class="pl-5 pr-5 pb-1 pt-1  bg-red-600 text-white text-l font-regular rounded hover:bg-red-700 cursor-pointer" id="ok" type="submit" size="20">Supprimer une ligne</button>
                <button id="validerFiche" class="pl-5 pr-5 pb-1 pt-1  bg-green-600 text-white text-l font-regular rounded hover:bg-green-700 cursor-pointer" id="annuler" type="reset" value="Effacer" size="20">Valider la fiche</button>
