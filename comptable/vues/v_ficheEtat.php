<div id="contenu" class=" mb-20 pb-10 mr-12 mt-5 w-full  shadow-lg h-auto">
                        ...
                        <tbody>
                            ...
                            if (count($lesinfosHorsForfait) <= 0) {
                                ...
                                foreach ($lesinfosHorsForfait as $infoHF) {
                                    ...
                                    if ($infoHF['numEtat'] == 1) {
                                        $icon = '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="green" class="w-10 h-10">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                                      </svg>
                                      ';
                                    } else if ($infoHF['numEtat'] == 2) {
                                        $icon = '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="blue" class="w-10 h-10">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                      </svg>
                                      
                                      ';
                                    } else if ($infoHF['numEtat'] == 3) {
                                        $icon = '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="red" class="w-10 h-10">
    ...
    <div class="borderButtonValidation d-relative  w-auto mt-5 h-auto pb-5 ml-20 mr-20">
        <p class="w-auto  ">
            <button onclick="window.location.href='index.php?uc=validerFrais&action=choixVisiteurMois'" class="pl-5 pr-5 pb-1 pt-1  bg-red-600 text-white text-l font-regular rounded hover:bg-red-700 cursor-pointer" type="submit" size="20">Annuler </button>
