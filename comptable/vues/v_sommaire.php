       ...
       <aside class="w-64" aria-label="Sidebar">
          <div id="sidebar" class="largeSidebar w-64 h-full overflow-y-auto py-4 px-3 bg-nav mt-32  dark:bg-gray-800">
             ...
             <ul id="menuList" class="space-y-2">
                ...
                <li>
                   <a href="index.php?uc=validerFrais&action=choixVisiteurMois" title="Selectionner Visiteur et mois" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg  sideBarItem">
                ...
                <li>
                   <a href="index.php?uc=suivrePaiement&action=selectionnerMois" title="Consultation de mes fiches de frais" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg  sideBarItem">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" class=" flex-shrink-0 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white w-10 h-10" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                         <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>



                      <span class="ml-3 text-white text-xl infoUser">Suivre paiement fiche de frais</span>
                   </a>
                </li>
                <li>
                   <a href="index.php?uc=connexion&action=deconnexion" title="Se déconnecter" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white sideBarItem">
