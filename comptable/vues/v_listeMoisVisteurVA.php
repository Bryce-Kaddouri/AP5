<div id="contenu" class="ml-72 mr-12 mt-5 bg-blanc1 shadow-lg h-auto">
    <div class="pt-2 mr-2 ml-2">
        <h2 class="w-auto h-12  bg-blue1 shadow-lg border-blue1 font-semibold text-3xl text-center  ">Suivi paiement fiche de frais</h2>
        <div class="border-solid border-2 border-black mt-12 ">
            ...
            <form action="index.php?uc=suivrePaiement&action=afficherListeFicheVA" method="post" class="flex d-flex">
